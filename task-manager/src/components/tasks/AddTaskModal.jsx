...
const AddTaskModal = ({ show, onHide }) => {
  ...
  return (
    <Modal show={show} onHide={onHide} centered backdrop="static" className="task-modal">
      <Modal.Header
        // Custom styling to position close button
        style={{
          display: 'flex',
          justifyContent: 'space-between', // Pushes title and close button to ends
          alignItems: 'center',
          borderBottom: 'none', // Remove default header border
          paddingBottom: '0',
          paddingTop: '1rem', // Adjust padding
          paddingRight: '1rem', // Adjust padding
          paddingLeft: '1rem', // Adjust padding
        }}
      >
        ...
        {/* Custom close button */}
        <Button
          variant="link" // Make it look like a link or simple icon
          onClick={onHide}
          // Smaller close icon
          style={{
            fontSize: '1.2rem', // Adjust size of 'x'
            color: '#6c757d', // A subtle grey color
            textDecoration: 'none', // Remove underline if variant="link" is used
      ...
      <Form onSubmit={handleSubmit}>
        <Modal.Body className="pt-2">
          ...
          <Form.Group className="mb-2" controlId="description">
            ...
            {/* Removed InputGroup.Text with icon */}
            <Form.Control
              as="textarea"
